              ...
              <div className="relative">
                <div className="relative z-20 flex flex-col p-5 h-full bg-white border-2 border-gray-800">
                  <span className="flex  w-8 h-8 mb-3 mr-8 bg-transparent rounded-lg">
                    <Image
                      priority
                      src={data.DigitalStreamsCards[5].StreamLogo.imageURL}
                      alt={
                        data.DigitalStreamsCards[5].StreamLogo.imageDescription
                      }
                      height={data.DigitalStreamsCards[5].StreamLogo.height}
                      width={data.DigitalStreamsCards[5].StreamLogo.width}
                    />
                  </span>
                  <h3 className="card-heading font-bold">
                    {" "}
                    {data.DigitalStreamsCards[5].StreamTitle}{" "}
                  </h3>
                  <p className="mt-4 card-subheading text-gray-700">
                    {data.DigitalStreamsCards[5].StreamDescription}
                  </p>
                  <div className="h-0.5 w-full border-b border-gray-200 my-8">
                    {" "}
                  </div>
                  <ul className="space-y-2 h-full">
                    {data.DigitalStreamsCards[5].FeaturePoints.map(
                      (feature) => (
                        <li
                          key="feature"
                          className="flex items-center text-gray-700 card-subheading sm:sm-card-subheading"
                  ...
                  <p className="mb-5 text-gray-600">
                    {" "}
                    {data.DigitalStreamsCards[5].StreamValuePoint}{" "}
                  </p>
                  <Link
                    href={data.DigitalStreamsCards[5].LandingPageURL}
                    passHref
                  >
                    <a
                      onClick={() => {
                        onClick({
                          stream_score: resolve_stream_score("CleanCore"),
                          event_name: "Link Click",
                          section_name: "Streams Section",
                          page_source: `${data.pageSEO.PageTitle}`,
                          label: "Learn More-Digital Clean Core",
                        });
                      }}
                      className="inline-flex items-center pb-1  text-mines-primary hover:border-blue-500 group "
                    >
              ...
              <div className="relative">
                <div className="relative z-20 flex flex-col p-5 h-full bg-white border-2 border-gray-800">
                  <span className="flex  w-8 h-8 mb-3 mr-8 bg-transparent rounded-lg">
                    <Image
                      priority
                      src={data.DigitalStreamsCards[6].StreamLogo.imageURL}
                      alt={
                        data.DigitalStreamsCards[6].StreamLogo.imageDescription
                      }
                      height={data.DigitalStreamsCards[6].StreamLogo.height}
                      width={data.DigitalStreamsCards[6].StreamLogo.width}
                    />
                  </span>
                  <h3 className="card-heading font-bold">
                    {" "}
                    {data.DigitalStreamsCards[6].StreamTitle}{" "}
                  </h3>
                  <p className="mt-4 card-subheading text-gray-700">
                    {data.DigitalStreamsCards[6].StreamDescription}
                  </p>
                  <div className="h-0.5 w-full border-b border-gray-200 my-8">
                    {" "}
                  </div>
                  <ul className="space-y-2 h-full">
                    {data.DigitalStreamsCards[6].FeaturePoints.map(
                      (feature) => (
                        <li
                          key="feature"
                          className="flex items-center text-gray-700 card-subheading sm:sm-card-subheading"
                  ...
                  <p className="mb-5 text-gray-600">
                    {" "}
                    {data.DigitalStreamsCards[6].StreamValuePoint}{" "}
                  </p>
                  <Link
                    href={data.DigitalStreamsCards[6].LandingPageURL}
                    passHref
                  >
                    <a
                      onClick={() => {
                        onClick({
                          stream_score: resolve_stream_score("hanapedia"),
                          event_name: "Link Click",
                          section_name: "Streams Section",
                          page_source: `${data.pageSEO.PageTitle}`,
                          label: "Learn More-Digital Hanapedia",
                        });
                      }}
                      className="inline-flex items-center pb-1  text-mines-primary hover:border-blue-500 group "
                    >
              ...
              <div className="relative">
                <div className="relative z-20 flex flex-col p-5 h-full bg-white border-2 border-gray-800">
                  <span className="flex  w-8 h-8 mb-3 mr-8 bg-transparent rounded-lg">
                    <Image
                      priority
                      src={data.DigitalStreamsCards[7].StreamLogo.imageURL}
                      alt={
                        data.DigitalStreamsCards[7].StreamLogo.imageDescription
                      }
                      height={data.DigitalStreamsCards[7].StreamLogo.height}
                      width={data.DigitalStreamsCards[7].StreamLogo.width}
                    />
                  </span>
                  <h3 className="card-heading font-bold">
                    {" "}
                    {data.DigitalStreamsCards[7].StreamTitle}{" "}
                  </h3>
                  <p className="mt-4 card-subheading text-gray-700">
                    {data.DigitalStreamsCards[7].StreamDescription}
                  </p>
                  <div className="h-0.5 w-full border-b border-gray-200 my-8">
                    {" "}
                  </div>
                  <ul className="space-y-2 h-full">
                    {data.DigitalStreamsCards[7].FeaturePoints.map(
                      (feature) => (
                        <li
                          key="feature"
                          className="flex items-center text-gray-700 card-subheading sm:sm-card-subheading"
                  ...
                  <p className="mb-5 text-gray-600">
                    {" "}
                    {data.DigitalStreamsCards[7].StreamValuePoint}{" "}
                  </p>
                  <Link
                    href={data.DigitalStreamsCards[7].LandingPageURL}
                    passHref
                  >
                    <a
                      onClick={() => {
                        onClick({
                          stream_score: resolve_stream_score("agentspace"),
                          event_name: "Link Click",
                          section_name: "Streams Section",
                          page_source: `${data.pageSEO.PageTitle}`,
                          label: "Learn More-Digital Agent Space",
                        });
                      }}
                      className="inline-flex items-center pb-1  text-mines-primary hover:border-blue-500 group "
                    >
